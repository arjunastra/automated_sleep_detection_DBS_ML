...
#PATH can be changed according to user directory where LFP power files are stored
...
num_train = 80 #optimal 80-100 - number of data points preceding current test point to use for training, including their labels
